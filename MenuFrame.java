...
public class MenuFrame extends JFrame 
{
   ...
   private final JRadioButton underlineItems; 
   ...
   public MenuFrame()
   {
      ...
      String[] styleNames = {"Bold", "Italic", "Underline"}; // names of styles
   ...
   private class ItemHandler implements ActionListener 
   {
      ...
      public void actionPerformed(ActionEvent event)
      {
         ...
         repaint(); // repinta a fonte
      } 
   } // end class ItemHandler

   // StyleHandler, manipulador de estilo. 
   private class StyleHandler implements ItemListener 
   {
      ...
      public void itemStateChanged(ItemEvent e)
      {
         ...
         if (styleItems[0].isSelected() && 
            ...
            font = new Font.BOLD + Font.ITALIC, 72;
          ...
          style = fontStyle;
         displayJLabel.setFont(name, fontStyle, 72);
